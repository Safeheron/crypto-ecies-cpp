...
{
public:
    IKDF(){hash_nid_ = 0; iv_ = "";};
    IKDF(int hash_nid){hash_nid_ = hash_nid; iv_ = "";};
    virtual ~IKDF(){};
...
protected:
    static bool baseKDF(int hash_nid, int iter_from, const unsigned char* input, size_t in_size, const unsigned char* salt, size_t salt_size, size_t out_size, std::string & out);
protected:
    int hash_nid_;
    std::string iv_;
};
...
public:
    KDF_X9_63(){hash_nid_ = 0; iv_ = "";};
    KDF_X9_63(int hash_nid){hash_nid_ = hash_nid; iv_ = "";};
    KDF_X9_63(int hash_nid, std::string iv){hash_nid_ = hash_nid; iv_ = iv;};
    virtual ~KDF_X9_63(){};
public:
...
public:
    KDF1_18033(){hash_nid_ = 0; iv_ = "";};
    KDF1_18033(int hash_nid){hash_nid_ = hash_nid; iv_ = "";};
    virtual ~KDF1_18033(){};
public:
    bool generateBytes(const unsigned char* input, size_t in_size, size_t out_size, std::string & out);
    bool generateBytes(const std::string & input, size_t out_size, std::string & out);
...
public:
    KDF2_18033(){hash_nid_ = 0; iv_ = "";};
    KDF2_18033(int hash_nid){hash_nid_ = hash_nid; iv_ = "";};
    virtual ~KDF2_18033(){};
public:
    bool generateBytes(const unsigned char* input, size_t in_size, size_t out_size, std::string & out);
    bool generateBytes(const std::string & input, size_t out_size, std::string & out);
